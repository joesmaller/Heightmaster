...
return function(Roact)
	local GridFrame = Roact.PureComponent:extend("GridFrame")
	...
	function GridFrame:_setCanvasSize(contentSize)
		self:setState(function(state)
			return {
	...
	function GridFrame:render()
		...
		return Roact.createElement("ScrollingFrame", {
			...
			VerticalScrollBarPosition = props.VerticalScrollBarPosition or Enum.VerticalScrollBarPosition.Right;
			...
			GridFrame = Roact.createElement("UIGridLayout", {
				-- UIGridLayout
				-- AbsoluteCellCount = props.AbsoluteCellCount;
				-- AbsoluteCellSize = props.AbsoluteCellSize;
				CellPadding = props.CellPadding or UDim2.new(0, 0, 0, 0);
